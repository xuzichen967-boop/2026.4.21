...
export const Generators = {
  Eagle: (): VoxelData[] => {
    ...
    // A larger stepped beak reads better from the camera angle while remaining vertically supported.
    addBox(0, 0, 10, 12, -4, -4, COLORS.GOLD);
    setBlock(map, 0, 11, -5, COLORS.GOLD);
